//
//  TestPPSnapshotHandlerWKWebViewVC.m
//  OverAllDemos
//
...
@interface TestPPSnapshotHandlerWKWebViewVC ()<PPSnapshotHandlerDelegate,WKUIDelegate>
{
    WKWebView *_wkCaptureView;
...
@implementation TestPPSnapshotHandlerWKWebViewVC
...
- (void)initConfigWKWebView
{
    ...
    [self.view addSubview:_wkCaptureView];
}
...
- (void)toCaptureScreenShotAction
{
     ...
     */
    [PPSnapshotHandler.defaultHandler snapshotForView:_wkCaptureView];
