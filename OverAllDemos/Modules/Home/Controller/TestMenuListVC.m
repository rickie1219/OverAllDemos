...
@interface TestMenuListVC ()<UIScrollViewDelegate>
{
    NSArray *arrList;
}
/** 标题栏 */
...
- (void)scrollViewDidEndScrollingAnimation:(UIScrollView *)scrollView
{
    ...
    // 打印frame
    CGFloat xx = newsVc.view.frame.origin.x;
    CGFloat yy = newsVc.view.frame.origin.y;
    CGFloat wit = newsVc.view.frame.size.width;
    CGFloat hig = newsVc.view.frame.size.height;
    
    NSLog(@"xx = %.2f, yy = %.2f, wit = %.2f, hig = %.2f", xx, yy, wit, hig);
