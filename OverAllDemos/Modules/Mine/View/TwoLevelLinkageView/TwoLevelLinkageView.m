...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([tableView isEqual:_leftSideTableView]) {
        /** 1.如果点击的是左边的tableView列表 */
        NSLog(@"--------- _leftSideTableView section = %ld row = %ld", indexPath.section, indexPath.row);
        ...
        /** 2.如果点击的是右边的tableView列表 */
        NSLog(@"--------- _rightSideTableView section = %ld row = %ld", indexPath.section, indexPath.row);
        // 点击cell事件
